...
const KineticistLoginScreen: React.FC = () => {
  ...
  const handleLogin = (): void => {
    console.log('Email:', email, 'Password:', password, 'Phone:', phoneNumber);
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        >
          ...
          {/* ── Titre + Sous-titre ── */}
          <Text style={styles.brandName}>PAYFLEX</Text>
...
export default KineticistLoginScreen;
...
const styles = StyleSheet.create({
  ...
  logoImage: { width: 65, height: 65, resizeMode: 'contain',borderRadius: 40, },
  brandName: {
    fontSize: 28,
    fontWeight: '800',
    color: '#1A1D2E',
